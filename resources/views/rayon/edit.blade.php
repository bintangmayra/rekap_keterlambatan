...
<div class="card mt-3">
    <div class="card-body p-5">
        <div class="justify-content-start jumbotron py-3" style="line-height: 5px; padding-bottom:30px;">
            ...
            <a>||</a>
            <a href="{{route('rayon.create')}}" class="btn btn-secondary" style="color: white; margin-top: 20px;">Edit Data Rayon </a> 
          </div>
          <div class="mt-3">
            <form action="{{ route('rayon.update', $rayon['id']) }}" method="POST">
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-info" style="color: white">Simpan</button>
                </div>
            </form>
        </div>
    </div>
