...
<div class="justify-content-start jumbotron py-3" style="line-height: 5px; padding-bottom:30px;">
  ...
  <a >||</a>
  <a href="{{route('student.index')}}" class="btn btn-secondary" style="color: white; margin-top: 20px;" >Data Siswa </a> 
  <a >||</a>
  <a href="{{route('student.create')}}" class="btn btn-secondary" style="color: white; margin-top: 20px;" >Tambah Data Siswa </a> 
</div>
    <form action="{{ route('student.store')}}" class="card mt-3 p-5" method="POST">
        ...
        <button type="submit" class="btn btn-info" style="color: white">Kirim Data</button>
    </form>
@endsection