...
<form action="{{ route('user.store') }}"class="" method="POST">
  <div class="justify-content-start jumbotron py-3" style="line-height: 5px; padding-bottom:30px;">
    ...
    <a >||</a>
    <a href="{{route('user.index')}}" class="btn btn-secondary" style="color: white; margin-top: 20px;" >Data User </a> 
    <a href="{{route('user.create')}}" class="btn btn-secondary" style="color: white; margin-top: 20px;" >Tambah Data User </a> 
  </div>
